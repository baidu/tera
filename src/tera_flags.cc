...
DEFINE_bool(tera_master_online_schema_upadte_enabled, false, "enable online-schema-update");
DEFINE_int32(tera_master_schema_update_poll_period, 1, "the period (in second) to poll schema update");
DEFINE_int32(tera_master_schema_update_retry_times, 600, "the max retry times of syncing new schema to ts");
