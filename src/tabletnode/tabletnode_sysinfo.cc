...
tera::AutoCollectorRegister dfs_read_metric(kDfsRequestMetric, kDfsReadLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_read_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_write_metric(kDfsRequestMetric, kDfsWriteLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_write_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_sync_metric(kDfsRequestMetric, kDfsSyncLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_sync_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_flush_metric(kDfsRequestMetric, kDfsFlushLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_flush_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_list_metric(kDfsRequestMetric, kDfsListLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_list_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_exists_metric(kDfsRequestMetric, kDfsExistsLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_exists_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_open_metric(kDfsRequestMetric, kDfsOpenLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_open_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_close_metric(kDfsRequestMetric, kDfsCloseLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_close_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_delete_metric(kDfsRequestMetric, kDfsDeleteLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_delete_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_tell_metric(kDfsRequestMetric, kDfsTellLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_tell_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_info_metric(kDfsRequestMetric, kDfsInfoLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_info_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_other_metric(kDfsRequestMetric, kDfsOtherLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_other_counter)), {SubscriberType::QPS});

tera::AutoCollectorRegister dfs_read_error_counter(kDfsErrorMetric, kDfsReadLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_read_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_write_error_counter(kDfsErrorMetric, kDfsWriteLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_write_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_sync_error_counter(kDfsErrorMetric, kDfsSyncLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_sync_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_flush_error_counter(kDfsErrorMetric, kDfsFlushLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_flush_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_list_error_counter(kDfsErrorMetric, kDfsListLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_list_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_exists_error_counter(kDfsErrorMetric, kDfsExistsLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_exists_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_open_error_counter(kDfsErrorMetric, kDfsOpenLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_open_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_close_error_counter(kDfsErrorMetric, kDfsCloseLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_close_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_delete_error_counter(kDfsErrorMetric, kDfsDeleteLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_delete_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_tell_error_counter(kDfsErrorMetric, kDfsTellLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_tell_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_info_error_counter(kDfsErrorMetric, kDfsInfoLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_info_error_counter)), {SubscriberType::QPS});
tera::AutoCollectorRegister dfs_other_error_counter(kDfsErrorMetric, kDfsOtherLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_other_error_counter)), {SubscriberType::QPS});
...
tera::AutoSubscriberRegister dfs_read_delay_avg_subscriber (std::unique_ptr<Subscriber>(new RatioSubscriber(
    ...
    std::unique_ptr<Subscriber>(new PrometheusSubscriber(MetricId(kDfsRequestMetric, kDfsReadLabel), SubscriberType::SUM)))));
...
tera::AutoSubscriberRegister dfs_write_delay_avg_subscriber (std::unique_ptr<Subscriber>(new RatioSubscriber(
    ...
    std::unique_ptr<Subscriber>(new PrometheusSubscriber(MetricId(kDfsRequestMetric, kDfsWriteLabel), SubscriberType::SUM)))));
...
tera::AutoSubscriberRegister dfs_sync_delay_avg_subscriber (std::unique_ptr<Subscriber>(new RatioSubscriber(
    ...
    std::unique_ptr<Subscriber>(new PrometheusSubscriber(MetricId(kDfsRequestMetric, kDfsSyncLabel), SubscriberType::SUM)))));

tera::AutoCollectorRegister dfs_read_hang_metric(kDfsHangMetric, kDfsReadLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_read_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_write_hang_metric(kDfsHangMetric, kDfsWriteLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_write_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_sync_hang_metric(kDfsHangMetric, kDfsSyncLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_sync_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_flush_hang_metric(kDfsHangMetric, kDfsFlushLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_flush_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_list_hang_metric(kDfsHangMetric, kDfsListLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_list_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_exists_hang_metric(kDfsHangMetric, kDfsExistsLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_exists_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_open_hang_metric(kDfsHangMetric, kDfsOpenLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_open_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_close_hang_metric(kDfsHangMetric, kDfsCloseLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_close_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_delete_hang_metric(kDfsHangMetric, kDfsDeleteLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_delete_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_tell_hang_metric(kDfsHangMetric, kDfsTellLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_tell_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_info_hang_metric(kDfsHangMetric, kDfsInfoLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_info_hang_counter)), {SubscriberType::SUM});
tera::AutoCollectorRegister dfs_other_hang_metric(kDfsHangMetric, kDfsOtherLabel,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_other_hang_counter)), {SubscriberType::SUM});

tera::AutoCollectorRegister dfs_opened_read_files_metric(kDfsOpenedReadFilesCountMetric,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_opened_read_files_counter, false)));
tera::AutoCollectorRegister dfs_opened_write_files_metric(kDfsOpenedWriteFilesCountMetric,
    std::unique_ptr<Collector>(new CounterCollector(&leveldb::dfs_opened_write_files_counter, false)));
// ssd metrics
...
void TabletNodeSysInfo::DumpLog() {
    ...
    int64_t read_delay_percentile_95 =
        finished_read_request == 0 ? 0 : latest_report->FindMetricValue(kRequestDelayPercentileMetric, kReadLabelPercentile95);
    int64_t read_delay_percentile_99 =
        finished_read_request == 0 ? 0 : latest_report->FindMetricValue(kRequestDelayPercentileMetric, kReadLabelPercentile99);
    int64_t write_delay_percentile_95 =
        finished_write_request == 0 ? 0 : latest_report->FindMetricValue(kRequestDelayPercentileMetric, kWriteLabelPercentile95);
    int64_t write_delay_percentile_99 =
        finished_write_request == 0 ? 0 : latest_report->FindMetricValue(kRequestDelayPercentileMetric, kWriteLabelPercentile99);
    int64_t scan_delay_percentile_95 =
        finished_scan_request == 0 ? 0 : latest_report->FindMetricValue(kRequestDelayPercentileMetric, kScanLabelPercentile95);
    int64_t scan_delay_percentile_99 =
        finished_scan_request == 0 ? 0 : latest_report->FindMetricValue(kRequestDelayPercentileMetric, kScanLabelPercentile99);
