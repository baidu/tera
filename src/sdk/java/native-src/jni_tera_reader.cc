...
#define NativeAddFamily \
    JNICALL Java_com_baidu_tera_client_TeraReaderImpl_nativeAddFamily
#define NativeDeleteReader \
    JNICALL Java_com_baidu_tera_client_TeraReaderImpl_nativeDeleteReader
...
JNIEXPORT jboolean NativeDeleteReader(JNIEnv *env, jobject jobj,
                                      jlong jreader) {
    tera::RowReader* reader = reinterpret_cast<tera::RowReader*>(jreader);
