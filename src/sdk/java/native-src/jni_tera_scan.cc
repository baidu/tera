...
#define NativeAddFamily \
    JNICALL Java_com_baidu_tera_client_TeraScanImpl_nativeAddFamily
#define NativeAddColumn \
    JNICALL Java_com_baidu_tera_client_TeraScanImpl_nativeAddColumn
#define NativeDeleteScanDesc \
    JNICALL Java_com_baidu_tera_client_TeraScanImpl_nativeDeleteScanDesc

JNIEXPORT jlong NativeNewScanDesc(JNIEnv *env, jobject jobj,
                                  jbyteArray jstartkey,
                                  jbyteArray jendkey) {
...
JNIEXPORT jboolean NativeAddFamily(JNIEnv *env, jobject jobj,
                                   jlong jdesc,
                                   jbyteArray jfamily) {
...
JNIEXPORT jboolean NativeAddColumn(JNIEnv *env, jobject jobj,
                                   jlong jdesc,
                                   jbyteArray jfamily,
                                   jbyteArray jcolumn) {
    tera::ScanDescriptor* desc = reinterpret_cast<tera::ScanDescriptor*>(jdesc);
...
JNIEXPORT void NativeDeleteScanDesc(JNIEnv *env, jobject jobj,
                                    jlong jdesc) {
    tera::ScanDescriptor* desc = reinterpret_cast<tera::ScanDescriptor*>(jdesc);
    if (desc != NULL) {
        delete desc;
