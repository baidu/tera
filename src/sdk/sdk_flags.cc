...
DEFINE_bool(tera_sdk_tso_client_enabled, false,
            "get timestamp from timeoracle, default from local timestamp");
DEFINE_int32(tera_gtxn_thread_max_num, 20,
             "the max thread number for global transaction operations");
DEFINE_int32(tera_gtxn_commit_timeout_ms, 600000,
             "global transaction timeout limit (ms) default 10 minutes");
...
DEFINE_int32(tera_gtxn_timeout_ms, 86400000,
             "global transaction timeout limit (ms) default 24 hours");

///////// SDK  /////////
DEFINE_string(tera_sdk_impl_type, "tera", "the activated type of SDK impl");
DEFINE_int32(tera_sdk_meta_read_retry_times, 10, "the max retry times during meta read");
...
DEFINE_int32(tera_sdk_async_sync_task_threshold, 1000,
             "the sync task threshold to do sync operation");
...
DEFINE_int32(tera_sdk_async_thread_min_num, 1,
             "the min thread number for tablet node impl operations");
DEFINE_int32(tera_sdk_async_thread_max_num, 200,
...
DEFINE_string(tera_sdk_root_table_addr, "127.0.0.1:22000",
              "the default table server has root_table");
...
DEFINE_int32(tera_sdk_rpc_limit_max_inflow, 10,
             "the max bandwidth (in MB/s) for sdk rpc traffic limitation on input flow");
DEFINE_int32(tera_sdk_rpc_limit_max_outflow, 10,
             "the max bandwidth (in MB/s) for sdk rpc traffic limitation on "
             "output flow");
DEFINE_int32(tera_sdk_rpc_max_pending_buffer_size, 200,
...
DEFINE_int32(tera_sdk_check_timer_internal, 100,
             "the sdk check the resend quest queue internal time");
DEFINE_int32(tera_sdk_timeout_precision, 100,
             "precision of sdk read/write timeout detector (in ms)");
...
DEFINE_int32(tera_sdk_read_timeout, 10000, "timeout of sdk readrequest (in ms)");
DEFINE_int32(tera_sdk_write_timeout, 10000, "timeout of sdk write request (in ms)");
...
DEFINE_int64(tera_sdk_max_mutation_pending_num, INT64_MAX,
             "default number of pending mutations in async put op");
DEFINE_int64(tera_sdk_max_reader_pending_num, INT64_MAX,
             "default number of pending readers in async get op");
DEFINE_bool(tera_sdk_async_blocking_enabled, true,
            "enable blocking when async writing and reading");
DEFINE_int32(tera_sdk_update_meta_concurrency, 3, "the concurrency for updating meta");
DEFINE_int32(tera_sdk_update_meta_buffer_limit, 102400,
             "(B) the pack size limit for updating meta");
...
DEFINE_int64(tera_sdk_perf_counter_log_interval, 60,
             "the interval period (in sec) of performance counter log dumping");
...
DEFINE_int64(tera_sdk_scan_timeout, 30000, "(ms) once scan timeout");
DEFINE_int32(tera_sdk_scan_max_retry, 10, "the max retry times for session scan");
DEFINE_int64(tera_sdk_scan_delay_retry_in_us, 1000000, "timewait in us before retry batch scan");
...
DEFINE_bool(tera_ins_enabled, false,
            "[obsoleted replace by --tera_coord_type=ins] option to open ins naming");
DEFINE_bool(tera_mock_ins_enabled, false,
            "[obsoleted replace by --tera_coord_type=mock_ins] option to open "
            "mock ins naming");
...
DEFINE_uint64(tera_sdk_read_max_qualifiers, 18446744073709551615U,
              "read qu limit of each cf, default value is the max of uint64");
...
DEFINE_string(tera_auth_group_name, "tera_dev", "tera auth group_name stands for service line");
DEFINE_int32(tera_sdk_get_tablet_retry_times, 10,
             "retry times for update meta when get tablet fail");

DEFINE_int32(tera_sdk_update_meta_rpc_timeout_max_ms, 300000,
             "requests on a server return rpc timeout max duration time(ms), over this threshold "
             "sdk will retry update meta");
