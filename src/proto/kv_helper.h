...
// table meta record
void MakeMetaTableKeyValue(const TableMeta& meta, std::string* key, std::string* value);
...
void ParseMetaTableKeyValue(const std::string& key, const std::string& value, TableMeta* meta);
...
// tablet meta record
void MakeMetaTableKeyValue(const TabletMeta& meta, std::string* key, std::string* value);
void MakeMetaTableKey(const std::string& table_name, const std::string& key_start,
                      std::string* key);
void MakeMetaTableValue(const TabletMeta& meta, std::string* value);

void ParseMetaTableKeyValue(const std::string& key, const std::string& value, TabletMeta* meta);
void ParseMetaTableKey(const std::string& key, std::string* table_name, std::string* key_start);
...
void MetaTableScanRange(const std::string& table_name, std::string* key_start,
                        std::string* key_end);
void MetaTableScanRange(const std::string& table_name, const std::string& tablet_key_start,
                        const std::string& tablet_key_end, std::string* key_start,
                        std::string* key_end);
