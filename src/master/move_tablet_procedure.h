...
// Notice that MoveTabletProcedure is splitted into a UnloadTabletProcedure and a LoadTabletProcedure, 
...
private:  
    ...
    MoveTabletPhase GetCurrentPhase() {
        return phases_.back();
    }
    
    void SetNextPhase(const MoveTabletPhase& phase) {
