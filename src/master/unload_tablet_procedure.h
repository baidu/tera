...
class UnloadTabletProcedure : public Procedure, public std::enable_shared_from_this<UnloadTabletProcedure> {
public:
...
private:
    ...
    void UnloadTabletCallback(UnloadTabletRequest* request, 
                            UnloadTabletResponse* response, 
                            bool failed, int error_code);
