...
typedef std::function<void (SplitTabletRequest*, SplitTabletResponse*, bool, int)> ComputeSplitKeyClosure;
...
private:
    typedef std::function<void (SplitTabletProcedure*, const SplitTabletPhase&)> SplitTabletPhaseHandler;
    ...
    void ComputeSplitKeyCallback(SplitTabletRequest* request, SplitTabletResponse* response, bool failed, int error_code);
