...
TEST_F(TabletStateMachineTest, LegalTransition) {
  ...
  EXPECT_TRUE(TransitFromState(TabletMeta::kTabletOffline, TabletEvent::kFinishSplitTablet));
  EXPECT_EQ(state_machine_.GetStatus(), TabletMeta::kTabletSplitted);
  EXPECT_TRUE(TransitFromState(TabletMeta::kTabletOffline, TabletEvent::kFinishMergeTablet));
  EXPECT_EQ(state_machine_.GetStatus(), TabletMeta::kTabletMerged);
