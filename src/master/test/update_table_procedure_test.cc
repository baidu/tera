...
public:
    UpdateTableProcedureTest() : tablet_manager_(new TabletManager(nullptr, nullptr, nullptr)), 
    ...
    virtual void SetUp() {
        ...
        update_proc_.reset(new UpdateTableProcedure(
                    table_, request_.get(), response_.get(), closure_.get(), nullptr));
    }
    
    
private:
    void InitMasterEnv() {
        MasterEnv().Init(nullptr, nullptr, 
                tablet_manager_, nullptr, nullptr, 
