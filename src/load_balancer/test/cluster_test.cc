...
TEST_F(ClusterTest, ValidActionTest) {
    ...
    cluster_->tablets_[tablet_index_meta]->tablet_ptr->SetStatus(TabletMeta::kTabletOffline);
    ...
    cluster_->tablets_[tablet_index_meta]->tablet_ptr->SetStatus(TabletMeta::kTabletReady);
    ...
    cluster_->tablets_[tablet_index_other]->tablet_ptr->SetStatus(TabletMeta::kTabletReady);
...
TEST_F(ClusterTest, AbnormalNodeConstructTest) {
    ...
    tablet_ptr_0->SetStatus(TabletMeta::kTabletReady);
    tablet_ptr_1->SetStatus(TabletMeta::kTabletReady);
    tablet_ptr_2->SetStatus(TabletMeta::kTabletReady);
    ...
    tablet_ptr_0->SetStatus(TabletMeta::kTabletOffline);
    cluster_.reset(new Cluster(lb_nodes, options));
    ASSERT_EQ(1, cluster_->initial_tablets_not_ready_per_node_[0].size());
    ASSERT_EQ(0, cluster_->abnormal_nodes_index_.size());

    tablet_ptr_1->SetStatus(TabletMeta::kTabletOffline);
    cluster_.reset(new Cluster(lb_nodes, options));
