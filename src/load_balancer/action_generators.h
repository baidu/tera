...
private:
    ...
    uint32_t PickMostReadNodeWithPending(const std::shared_ptr<Cluster>& cluster);
...
private:
    ...
    uint32_t PickMostWriteNodeWithPending(const std::shared_ptr<Cluster>& cluster);
...
private:
    ...
    uint32_t PickMostScanNodeWithPending(const std::shared_ptr<Cluster>& cluster);
