...
extern void leveldb_put(leveldb_t* db, const leveldb_writeoptions_t* options, const char* key,
                        size_t keylen, const char* val, size_t vallen, char** errptr);

extern void leveldb_delete(leveldb_t* db, const leveldb_writeoptions_t* options, const char* key,
...
extern char* leveldb_get(leveldb_t* db, const leveldb_readoptions_t* options, const char* key,
...
extern void leveldb_compact_range(leveldb_t* db, const char* start_key, size_t start_key_len,
...
extern void leveldb_writebatch_put(leveldb_writebatch_t*, const char* key, size_t klen,
...
extern leveldb_filterpolicy_t* leveldb_filterpolicy_create(
    ...
    unsigned char (*key_may_match)(void*, const char* key, size_t length, const char* filter,
