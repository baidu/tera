...
class MemTable {
 public:
  ...
  explicit MemTable(const InternalKeyComparator& comparator,
          CompactStrategyFactory* compact_strategy_factory = NULL);
  ...
  // Else, return false.
  virtual bool Get(const LookupKey& key, std::string* value, std::map<uint64_t, uint64_t> rollbacks, Status* s);
