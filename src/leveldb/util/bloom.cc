...
class BloomFilterPolicy : public FilterPolicy {
 ...
 public:
  explicit BloomFilterPolicy(int bits_per_key, BloomHashMethod hash_method)
      : bits_per_key_(bits_per_key), hash_method_(hash_method) {
  ...
  virtual const char* Name() const { return "leveldb.BuiltinBloomFilter"; }
...
class RowKeyBloomFilterPolicy : public BloomFilterPolicy {
 ...
 public:
  explicit RowKeyBloomFilterPolicy(int bits_per_key, BloomHashMethod hash_method,
      ...
      : BloomFilterPolicy(bits_per_key, hash_method), raw_key_operator_(raw_key_operator) {}

  virtual const char* Name() const { return "tera.RowKeyBloomFilter"; }
...
const FilterPolicy* NewRowKeyBloomFilterPolicy(int bits_per_key,
                                               const RawKeyOperator* raw_key_operator) {
